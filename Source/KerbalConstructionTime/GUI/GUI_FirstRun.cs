    ...
    public static partial class KCT_GUI
    {
        ...
        public static void DrawFirstRun(int windowID)
        {
            ...
            if (!KCTGameStates.StarterLCBuilding)
            {
                ...
                GUILayout.Label("To know what size LC you need, you should go to the VAB and create/load a vessel, and then click New in the Space Center Management (was KCT) window. The LC properties will be set to support that vessel.\nYou can also access the New LC window from the main Space Center Management UI's Operations tab, if you know what properties you want. Once you have LCs built you can also modify them the same way.", multilineStyle, UIHolder.MaxWidth(_firstRunWindowWidth));
            ...
            {
                GUILayout.Label($"{step++}) Assign your {KCTGameStates.UnassignedPersonnel} starting Applicants", multilineStyle, UIHolder.MaxWidth(480));
